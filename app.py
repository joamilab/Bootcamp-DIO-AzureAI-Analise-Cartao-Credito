...
from services.credit_card_service import analyze_credit_card_info
...
def configure_interface():
    ...
    if uploaded_file is not None:
        ...
        if blob_url:
            st.write(f"Arquivo {fileName} enviado com sucesso para Azure Blob Storage")
            credit_card_info = analyze_credit_card_info(blob_url)
